...
func (s *StatusServer) buildStatusData() StatusData {
	...
	return StatusData{
		...
		FastEmptyNotifyLastSec:         rpcGBTTiming.FastEmptyNotifyLast,
		FastEmptyNotifyMaxSec:          rpcGBTTiming.FastEmptyNotifyMax,
		FastEmptyNotifyCount:           rpcGBTTiming.FastEmptyNotifyCount,
