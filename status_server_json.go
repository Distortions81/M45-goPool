...
func (s *StatusServer) handlePoolPageJSON(w http.ResponseWriter, r *http.Request) {
	...
	s.serveCachedJSON(w, key, overviewRefreshInterval, func() ([]byte, error) {
		...
		data := PoolPageData{
			...
			RPCGBTHeadersLastSec:            view.RPCGBTHeadersLastSec,
			RPCGBTBodyLastSec:               view.RPCGBTBodyLastSec,
			RPCGBTDecodeLastSec:             view.RPCGBTDecodeLastSec,
			RPCGBTApplyNotifyLastSec:        view.RPCGBTApplyNotifyLastSec,
			RPCGBTApplyNotifyMaxSec:         view.RPCGBTApplyNotifyMaxSec,
			RPCGBTApplyNotifyCount:          view.RPCGBTApplyNotifyCount,
			FastEmptyNotifyLastSec:          view.FastEmptyNotifyLastSec,
			FastEmptyNotifyMaxSec:           view.FastEmptyNotifyMaxSec,
			FastEmptyNotifyCount:            view.FastEmptyNotifyCount,
