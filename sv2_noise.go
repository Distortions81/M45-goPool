...
//
// ESP-Miner's SV2 branch starts with a Noise handshake, while some test
// fixtures and proxies use plaintext SV2 framing.
...
func newSV2FrameTransportAuto(r io.Reader, w io.Writer) (sv2FrameTransport, sv2TransportDetection, error) {
	...
	switch d.mode {
	case "noise":
		return newSV2NoiseFrameTransport(r, w), d, nil
	default:
